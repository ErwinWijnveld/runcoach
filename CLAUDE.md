...
- Dutch UI string extraction (Phase 3 of i18n — ~700 strings) and agent localization (Phase 4 — Dutch directive on system prompts). Foundation is in place; see the i18n bullet above.
