...
/// Renders from locally-persisted data (no live source call) so it works
/// offline and opens instantly. Source-aware icon + label.
class WearableSummaryCard extends StatelessWidget {
  final WearableActivitySummary activity;
  ...
  Widget build(BuildContext context) {
    final accent = _sourceColor(activity.source);
