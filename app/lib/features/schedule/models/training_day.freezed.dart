...
@override
String toString() {
  return 'TrainingDay(id: $id, date: $date, type: $type, title: $title, description: $description, targetKm: $targetKm, targetPaceSecondsPerKm: $targetPaceSecondsPerKm, targetHeartRateZone: $targetHeartRateZone, intervals: $intervals, order: $order, result: $result, updatedAt: $updatedAt)';
}
