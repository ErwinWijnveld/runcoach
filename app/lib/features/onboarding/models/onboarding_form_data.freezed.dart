...
@JsonKey(name: 'goal_time_seconds') int? get goalTimeSeconds;@JsonKey(name: 'pr_current_seconds') int? get prCurrentSeconds;@JsonKey(name: 'days_per_week') int? get daysPerWeek;@JsonKey(name: 'coach_style') CoachStyleOption? get coachStyle; String? get notes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,goalType,goalName,distanceMeters,targetDate,goalTimeSeconds,prCurrentSeconds,daysPerWeek,coachStyle,notes);

@override
String toString() {
  return 'OnboardingFormData(goalType: $goalType, goalName: $goalName, distanceMeters: $distanceMeters, targetDate: $targetDate, goalTimeSeconds: $goalTimeSeconds, prCurrentSeconds: $prCurrentSeconds, daysPerWeek: $daysPerWeek, coachStyle: $coachStyle, notes: $notes)';
}
...
/// Create a copy of OnboardingFormData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? goalType = freezed,Object? goalName = freezed,Object? distanceMeters = freezed,Object? targetDate = freezed,Object? goalTimeSeconds = freezed,Object? prCurrentSeconds = freezed,Object? daysPerWeek = freezed,Object? coachStyle = freezed,Object? notes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'goal_type')  OnboardingGoalType? goalType, @JsonKey(name: 'goal_name')  String? goalName, @JsonKey(name: 'distance_meters')  int? distanceMeters, @JsonKey(name: 'target_date')  String? targetDate, @JsonKey(name: 'goal_time_seconds')  int? goalTimeSeconds, @JsonKey(name: 'pr_current_seconds')  int? prCurrentSeconds, @JsonKey(name: 'days_per_week')  int? daysPerWeek, @JsonKey(name: 'coach_style')  CoachStyleOption? coachStyle,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnboardingFormData() when $default != null:
return $default(_that.goalType,_that.goalName,_that.distanceMeters,_that.targetDate,_that.goalTimeSeconds,_that.prCurrentSeconds,_that.daysPerWeek,_that.coachStyle,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'goal_type')  OnboardingGoalType? goalType, @JsonKey(name: 'goal_name')  String? goalName, @JsonKey(name: 'distance_meters')  int? distanceMeters, @JsonKey(name: 'target_date')  String? targetDate, @JsonKey(name: 'goal_time_seconds')  int? goalTimeSeconds, @JsonKey(name: 'pr_current_seconds')  int? prCurrentSeconds, @JsonKey(name: 'days_per_week')  int? daysPerWeek, @JsonKey(name: 'coach_style')  CoachStyleOption? coachStyle,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _OnboardingFormData():
return $default(_that.goalType,_that.goalName,_that.distanceMeters,_that.targetDate,_that.goalTimeSeconds,_that.prCurrentSeconds,_that.daysPerWeek,_that.coachStyle,_that.notes);}
}
...
/// Create a copy of OnboardingFormData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? goalType = freezed,Object? goalName = freezed,Object? distanceMeters = freezed,Object? targetDate = freezed,Object? goalTimeSeconds = freezed,Object? prCurrentSeconds = freezed,Object? daysPerWeek = freezed,Object? coachStyle = freezed,Object? notes = freezed,}) {
