...
@JsonKey(name: 'heart_rate_zones_source') String? get heartRateZonesSource;// Manually-entered birth year (persisted by HeartRateZonesController
...
@JsonKey(name: 'birth_year') int? get birthYear;@JsonKey(name: 'pending_plan_generation') PlanGeneration? get pendingPlanGeneration;@JsonKey(name: 'current_membership') Membership? get currentMembership;@JsonKey(name: 'pending_invites') List<Membership> get pendingInvites;@JsonKey(name: 'pending_requests') List<Membership> get pendingRequests;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,appleSub,coachStyle,hasCompletedOnboarding,const DeepCollectionEquality().hash(heartRateZones),heartRateZonesSource,birthYear,pendingPlanGeneration,currentMembership,const DeepCollectionEquality().hash(pendingInvites),const DeepCollectionEquality().hash(pendingRequests));

@override
String toString() {
  return 'User(id: $id, name: $name, email: $email, appleSub: $appleSub, coachStyle: $coachStyle, hasCompletedOnboarding: $hasCompletedOnboarding, heartRateZones: $heartRateZones, heartRateZonesSource: $heartRateZonesSource, birthYear: $birthYear, pendingPlanGeneration: $pendingPlanGeneration, currentMembership: $currentMembership, pendingInvites: $pendingInvites, pendingRequests: $pendingRequests)';
}
...
@useResult
$Res call({
 int id, String name, String email,@JsonKey(name: 'apple_sub') String? appleSub,@JsonKey(name: 'coach_style') String? coachStyle,@JsonKey(name: 'has_completed_onboarding') bool hasCompletedOnboarding,@JsonKey(name: 'heart_rate_zones') List<HrZone>? heartRateZones,@JsonKey(name: 'heart_rate_zones_source') String? heartRateZonesSource,@JsonKey(name: 'birth_year') int? birthYear,@JsonKey(name: 'pending_plan_generation') PlanGeneration? pendingPlanGeneration,@JsonKey(name: 'current_membership') Membership? currentMembership,@JsonKey(name: 'pending_invites') List<Membership> pendingInvites,@JsonKey(name: 'pending_requests') List<Membership> pendingRequests
});
...
as int?,pendingPlanGeneration: freezed == pendingPlanGeneration ? _self.pendingPlanGeneration : pendingPlanGeneration // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.appleSub,_that.coachStyle,_that.hasCompletedOnboarding,_that.heartRateZones,_that.heartRateZonesSource,_that.birthYear,_that.pendingPlanGeneration,_that.currentMembership,_that.pendingInvites,_that.pendingRequests);case _:
  return orElse();
...
switch (_that) {
case _User():
return $default(_that.id,_that.name,_that.email,_that.appleSub,_that.coachStyle,_that.hasCompletedOnboarding,_that.heartRateZones,_that.heartRateZonesSource,_that.birthYear,_that.pendingPlanGeneration,_that.currentMembership,_that.pendingInvites,_that.pendingRequests);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,email,appleSub,coachStyle,hasCompletedOnboarding,const DeepCollectionEquality().hash(_heartRateZones),heartRateZonesSource,birthYear,pendingPlanGeneration,currentMembership,const DeepCollectionEquality().hash(_pendingInvites),const DeepCollectionEquality().hash(_pendingRequests));
